...
class TitleScene extends BaseScene {
    ...
    preload() {
        ...
        // Load the title background - use the static path
        this.load.image('title-bg', 'static/assets/images/backgrounds/title.png');
        
        // Debug log to verify the image is being loaded
        console.log('Loading title background image from static/assets/images/backgrounds/title.png');
    }
    ...
    create() {
        ...
        startButton.on('pointerdown', () => {
            ...
            if (this.scene.get('TestScene')) {
                this.transitionTo('TestScene');
            } else {
                console.log('TestScene not available');
            }
        });
...
if (window.sceneRegistry) {
    window.sceneRegistry.register('TitleScene', TitleScene);
} 