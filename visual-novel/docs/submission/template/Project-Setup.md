...
## Template Files
These files are in the `dev/template` folder, and they also serve as a reference for the starting structure of the new project:
...
- [ ] Copy the following files directly to the root of the project folder:
  ...
  - [ ] `.env.example`
  - [ ] `.gitignore`
  - [ ] `dev/.cursorrules.macos`
  - [ ] `dev/.cursorrules.windows`
